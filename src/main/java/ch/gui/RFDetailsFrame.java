...
public class RFDetailsFrame extends MyFrame {
	...
	public RFDetailsFrame(JFrame parent, ReadyFood rf) {
		super(parent);
		trans = rf;
		this.setBounds(100, 100, 519, 325);
	...
	private void updateLabels(Double d) {
		lCalinCustom.setText(String.valueOf(trans.getCalories(d)));
		lCarbinCustom.setText(String.valueOf(trans.getCarbons(d)));
		lFatinCustom.setText(String.valueOf(trans.getFat(d)));
		lProtinCustom.setText(String.valueOf(trans.getProteins(d)));
		repaint();
	}
}
